...
<head>
    ...
    <title>Cotswold League Results Matcher</title>
...
<body>
    ...
    <div class="no-print max-w-4xl mx-auto mt-8 p-4">
        ...
        <div class="control-group">
            ...
            <p class="text-sm text-gray-600 mb-3">Upload your Excel file containing swimmer names (the same one used for
                the programme).</p>
            <div class="flex gap-4 items-center">
                <input type="file" id="teamsheetInput" accept=".xlsx, .xls, .csv"
                    class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" />
                <select id="teamSheetSelector"
    ...
    <script>
        ...
        document.getElementById('teamsheetInput').addEventListener('change', handleTeamsheetUpload);
