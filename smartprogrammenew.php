    ...
    <div id="controlPanel" class="no-print bg-yellow-50 border-b border-yellow-200 p-6 flex flex-col items-center justify-center gap-4 shadow-sm">
        ...
        <?php else: ?>
            <div class="text-center">
                ...
                <p class="text-sm text-yellow-800">Paste your Teamsheet URL.</p>
            </div>
            ...
            <button onclick="importManualUrl()" class="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition font-bold flex items-center gap-2">
                Load URL
            </button>
